...
class DataLoader:
    ...
    def display_metadata(self):
        ...
        print("\n--- Metadata ---")
        metadata = self.metadata_entry.get("metadata", {})
...
if __name__ == "__main__":
    data_loader = DataLoader(PKL_PATH)
    data_loader.display_metadata()
    selected_capture = data_loader.get_capture_data()
    data_loader.display_capture_data(selected_capture)
    data_loader.plot_capture_data(selected_capture)
