import cv2
from cc_hardware.drivers.cameras.realsense import RealsenseCamera, RealsenseConfig

camera = RealsenseCamera(RealsenseConfig())
rgb, depth = camera.accumulate(num_samples=1, return_rgb=True, return_depth=True)
